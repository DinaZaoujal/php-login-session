...
- `login.php` — loginformulier en verificatie.  
  ...
  - Bij succesvolle login wordt een session aangemaakt en wordt doorgestuurd naar `index.php`
  - Bij foutieve inloggegevens wordt een duidelijke foutmelding getoond
